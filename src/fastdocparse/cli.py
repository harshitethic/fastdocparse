...
def extract(
    ...
    ocr_min_confidence: float = typer.Option(0.3, "--ocr-min-confidence", help="Discard OCR text below this confidence threshold, 0 to 1 (default: 0.3)."),
    max_concurrent_chunks: int = typer.Option(1, "--max-concurrent-chunks", help="Maximum extraction chunks processed concurrently (default: 1)."),
):
